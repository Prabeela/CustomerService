...
public class CustomerRepository {
    ...
    private final String SQL_INSERT = "insert into customer-541455(id,email,first_name,last_name,created,modified) values(?,?,?,?,?,?)";
    private final String SQL_QUERY_ALL = "select * from customer-541455";
    private final String SQL_QUERY_BY_ID = "select * from customer-541455 where id=?";
